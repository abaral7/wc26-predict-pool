...
export async function setPtfCredentials() {
  throw new Error("PTF credentials storage not supported by the API adapter — set PTF_SESSION and PTF_CSRF env vars instead");
}

export async function getWc26Token() { return null; }
export async function setWc26Token() {
  throw new Error("WC26 token storage not supported by the API adapter — set WC26_TOKEN env var instead");
}
